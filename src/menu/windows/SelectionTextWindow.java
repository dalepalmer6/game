...
public class SelectionTextWindow extends TextWindow implements Controllable{
	...
	public SelectionTextWindow(int x, int y, int width, int height, SystemState m) {
		this("vertical",x,y,width,height,m);
	}
	
	public SelectionTextWindow(String orientation, int x, int y, int width, int height, SystemState m) {
