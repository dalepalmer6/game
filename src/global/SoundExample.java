...
public class SoundExample {
    ...
    */
    public void init() {
	    ...
	    // a sound
	    oggEffect = AudioLoader.getAudio("WAV", ResourceLoader.getResourceAsStream("audio/eb_title.wav"));
	    ...
	    oggStream = AudioLoader.getStreamingAudio("OGG", ResourceLoader.getResource("audio/pollyanna.ogg"));
