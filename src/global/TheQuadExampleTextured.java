...
public class TheQuadExampleTextured {
    ...
    private void setupShaders() {       
        ...
        vsId = this.loadShader("src/shaders/vertex_textured.glsl", GL20.GL_VERTEX_SHADER);
        // Load the fragment shader
        fsId = this.loadShader("src/shaders/fragment_textured.glsl", GL20.GL_FRAGMENT_SHADER);
