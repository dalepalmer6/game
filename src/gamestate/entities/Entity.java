...
public class Entity implements Drawable,EntityInterface {
	...
	private int moveSpeedThisFrame;
...
//					SystemState.out.println("Trying to find new movement vector.");
//					deltaX = (int) (vectorLength * Math.cos(angleToCheck));
//					deltaY = (int) (vectorLength * Math.sin(angleToCheck));
////					x += deltaX;
////					y += deltaY;
//					if (((colmask = checkTileCollision())&15) == 0) {
//						SystemState.out.println("Suitable found " + deltaX + "," + deltaY);
//						exit = true;
//						break;
//					} else {
//						deltaX = 0;
...
//		determinePositionWithCamera();
	...
	public Entity(String texture, double x, double y, int width, int height,SystemState m,String name) {
...
//			SystemState.out.println("Detected a collide");
			return true;
	}
	return false;
	}
...
//		this.directionY = dirY;
	...
	public void setActionTaken(String string) {
		this.actionTaken = string;		
	}
	
	public void setDirectionX(String dirX) {
		this.directionX = dirX;
	}
	
	public void setDirectionY(String dirY) {
		this.directionY = dirY;
	}
